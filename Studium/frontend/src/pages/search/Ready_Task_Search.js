...
function Ready_Task_Element(props){
    return(
                ...
                <div className='menu_element_wrapper_container'>
                    ...
                    <div className='menu_element_side_container'>
                        ...
                        <Link className='menu_element_author_link' to={`/user/${props.data.owner}`}>
                            <div className='menu_element_author' id='grey_font'>{props.data.author || `Пользователь ${props.data.owner}`}</div>
                        </Link>
                    </div>
                </div>
            </div>
...
function Ready_Tasks_Search() {
    ...
    return (
        <Search_Function searchURL="/api/rt/all/" addData={{ isTaskSearch:true, searchText:"готовых работ" }} searchElement={Ready_Task_Element} rightSection={Right_Menu_Task_Section}/>
    );
}
